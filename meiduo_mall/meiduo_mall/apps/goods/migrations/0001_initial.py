    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.spu', verbose_name='商品SPU')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spec', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.spuspecification', verbose_name='规格')),
            ],
            options={
                'verbose_name': '规格选项',
